...
<section class="py-6 px-6 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <div class="rounded-xl p-4 bg-gradient-to-br {{ $hotCategory->classColor }} shadow hover:scale-105 transition">
                ...
                <div class="relative group-carousel">
                    ...
                    <div class="overflow-hidden">
                        <div class="carousel-track flex transition-transform duration-500 ease-in-out">
                            ...
                            @for ($i = 0; $i < count($koreaMovies); $i++) <div class="min-w-[33.3333%] px-2 box-border">
                ...
                <div class="overflow-hidden">
                    <div class="carousel-track flex transition-transform duration-500 ease-in-out">
                        ...
                        @for ($i = 0; $i < count($animeMovies); $i++) <div class="min-w-[33.3333%] px-2 box-border">
                            <div class="bg-[#1d1d1d] rounded-xl overflow-hidden shadow-lg">
                                <img src="{{ asset($animeMovies[$i]->thumbnail) }}" alt="{{ $animeMovies[$i]->title }}"
                                    class="w-full h-[170px] object-cover" />
                                <div class="p-2">
