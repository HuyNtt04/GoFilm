...
<main class="pt-28 max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                            ...
                            <div class="flex items-center space-x-2 w-1/2">
                                <input type="checkbox" name="countries[]" value="{{ $country->country }}"
                                    id="country_{{ $country->country }}" class="accent-yellow-400">
                        ...
                        <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                            ...
                            <div class="flex items-center space-x-2 w-1/2">
                                <input type="checkbox" name="categories[]" value="{{ $category->id }}"
                                    id="category_{{ $category->id }}" class="accent-yellow-400">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                            ...
                            <div class="flex items-center space-x-2 w-1/2">
                                <input type="checkbox" name="years[]" value="{{ $year->release_year }}"
                                    id="year_{{ $year->release_year }}" class="accent-yellow-400">
    ...
    <div id="movieList" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
        ...
        <div class="bg-white/5 rounded-md overflow-hidden shadow hover:scale-[1.02] transition duration-200">
            <a href="{{ route('MovieInfo.show', $movie->id) }}">
                <img src="{{ asset($movie->thumbnail) }}" alt="{{ $movie->title }}" class="w-full h-60 object-cover">
                <div class="p-3">
