                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-col items-center justify-center mb-6 pb-6 border-b border-gray-700/50">
                            <div class="w-24 h-24 rounded-full overflow-hidden mb-3">
                                <img src="{{ asset('images/'.$user -> image) }}" alt="User avatar"
                    ...
                    <div class="relative">
                        <div class="overflow-hidden">
                            <div id="favorites-slider"
                                ...
                                <!-- Movie Posters -->
                                @foreach($userFavoriteMovies as $userFavoriteMovie)
                                <div
                                    ...
                                    <a href="#" class="block w-full h-full relative">
                                        <img src="{{ asset($userFavoriteMovie->thumbnail) }}"
                                            alt="{{ $userFavoriteMovie->title }}" class="w-full h-full object-cover">
                                        <div
                                            ...
                                            <a href="{{ route('MovieInfo.show', $userFavoriteMovie->id) }}">
                                                <h3 class="text-sm font-medium truncate">{{ $userFavoriteMovie->title }}
                                                </h3>
                                            </a>
                                        </div>
                                    </a>
                                    <form action="{{ route('FavoriteMovies.destroyFavoriteInProfile') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $userFavoriteMovie->favoriteID }}">
                                        <button
                                    ...
                                    <div class="flex items-center space-x-6 mt-2">
                                        <label class="inline-flex items-center">
                                            <input value="1" type="radio" name="gender"
                                                class="form-radio text-yellow-500" @if($user -> gender == 1) checked
                                            @endif />
                                            <span class="ml-2">Nam</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input value="2" type="radio" name="gender"
                                                class="form-radio text-yellow-500" @if($user -> gender == 2) checked
                                            @endif />
                                            <span class="ml-2">Nữ</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input value="0" type="radio" name="gender"
                                                class="form-radio text-yellow-500" @if($user -> gender == 0) checked
                                            @endif />
