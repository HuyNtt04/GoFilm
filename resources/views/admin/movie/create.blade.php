        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.movie.create') }}">Add Movie</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="recentOrders">
    ...
    <div class="form-container">
        <form data-parsley-validate action="{{ route('admin.movie.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
