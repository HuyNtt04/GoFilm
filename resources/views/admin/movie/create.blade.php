...
<div class="recentOrders">
    <div class="cardHeader">
        <h2>Thêm Phim</h2>
        <a href="{{route('admin.movie.index')}}" class="btn-secondary">Quay Lại</a>
    </div>
    <div class="form-container">
        <form data-parsley-validate action="{{ route('admin.movie.store') }}" method="POST"
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        @endif
                        name="id_category[]" value="{{ $category->id }}"> {{ $category->name }}
                    </div>
                    @endforeach
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" required data-parsley-maxlength="255"
