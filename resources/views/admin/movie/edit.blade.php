...
<div class="container recentOrders">
    ...
    <div class="form-container">
        <form data-parsley-validate action="{{ route('admin.movie.update', $movie->id) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" @if ($loop->first)
                        ...
                        {{ in_array($category->id, $movieCategories) ? 'checked':''}} >{{$category->name }}
                    </div>
                    @endforeach
                </div>
            </div>
            <div class="form-group">
                ...
                <input type="text" name="title" required data-parsley-maxlength="255"
                    data-parsley-required-message="Vui lòng nhập tiêu đề"
                    data-parsley-maxlength-message="Tiêu đề không được dài quá 255 ký tự" class="form-control"
            ...
            <div class="form-group">
                ...
                <select required name="is_series" id="is_series">
            ...
            <div class="form-group">
                ...
                <input type="file" id="thumbnail" name="thumbnail" class="form-control" required
                    accept=".jpeg,.jpg,.png,.gif,.svg" data-parsley-required-message="Vui lòng chọn ảnh"
            ...
            <div class="form-group">
                ...
                <input type="text" name="cast" class="form-control" required
                    data-parsley-required-message="Vui lòng thêm diễn viên" value="{{old('cast', $movie->cast )}}">
                @error('cast')
                <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="release_year" class="form-control" required data-parsley-type="number"
            ...
            <div class="form-group">
                ...
                <input type="text" name="country" class="form-control" required
                    data-parsley-required-message="Vui lòng thêm quốc gia" value="{{old('country', $movie->country )}}">
                @error('country')
                <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="number" name="views" class="form-control" required data-parsley-type="number"
                    data-parsley-required-message="Vui lòng nhập lượt xem"
                    data-parsley-type-message="Vui lòng nhập lượt xem hợp lệ" value="{{old('views', $movie->views )}}">
                @error('views')
                <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="number" name="film_duration" class="form-control" required data-parsley-type="number"
            ...
            <div class="form-group">
                ...
                <input type="text" name="trailer_url" id="trailer_url" class="form-control"
                    value="{{  old('trailer_url', optional($movie)->trailer_url) }}" required data-parsley-type="url"
                    data-parsley-required-message=" Vui lòng nhập link preview trailer"
                    data-parsley-type-message="Vui lòng nhập link preview trailer hợp lệ">
                @error('trailer_url')
                <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="file" name="image[]" id="images" class="form-control" required
                    data-parsley-required-message="Vui lòng chọn ít nhất một hình ảnh" data-parsley-filemax="2048"
                    data-parsley-filetype="image" data-parsley-filetypes="jpeg,png,jpg,gif,svg"
                    data-parsley-maxsize="2048" value="{{old('image', $movie->image )}}" multiple>
