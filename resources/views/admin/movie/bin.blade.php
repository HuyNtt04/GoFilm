        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.movie.bin') }}">Bin</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="recentOrders">
    <div class="cardHeader">
        ...
        <a href="{{ route('admin.movie.bin.restore') }}" id="restore">Phục hồi</a>
        <a href="{{ route('admin.movie.bin.delete') }}" class="btn" id="delete">
        ...
        <tbody>
            ...
            <tr id="movie-{{ $movie->id }}">
                ...
                <td>
                    ...
                    <button type="submit" name="isDeleted" class="restore btn-link" data-id="{{ $movie->id }}">Phục hồi</button>
                    <form action="{{ route('admin.movie.destroy', $movie->id) }}" method="POST"
                        style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="button" class="delete-forever btn-delete">Xóa Vĩnh Viễn</button>
                    </form>
                </td>
            </tr>
            @endforeach
...
{{-- Giữ nguyên modal chi tiết phim như cũ --}}
...
@push('scripts')
<script type='module' src="{{ asset('js/admin/movie/bin.js') }}"></script>
