        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.urls.index',$episodeID) }}">Urls</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="recentOrders">
    <div class="cardHeader">
        <h2>Urls</h2>
        <a href="{{ route('admin.urls.create',['episode'=>$episodeID]) }}" class="btn-add">Thêm Url</a>
...
@push('scripts')
<script type='module' src="{{ asset('js/admin/urls/delete.js') }}"></script>
