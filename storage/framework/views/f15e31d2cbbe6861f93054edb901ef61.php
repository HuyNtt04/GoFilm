...
<div class="container">
    <div class="login-container">
        <div class="login-header">
            <h1>Đăng nhập</h1>
            <p>Nếu bạn chưa có tài khoản, <a href="<?php echo e(route('register')); ?>" style="color: #ffd700;">đăng ký ngay</a></p>
        </div>
...
<?php echo $__env->make('./layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DuAnTotNghiep\Project\download\final4\GoFilm\GoFilm\resources\views/auth/login.blade.php ENDPATH**/ ?>