    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr id="user-<?php echo e($user->id); ?>">
                <td>
                    <label class="container">
                        <input type="checkbox" class="delete-checkbox" value="<?php echo e($user->id); ?>">
                        <div class="checkmark"></div>
                    </label>
                </td>
...
<script type="module" src="<?php echo e(asset('js/admin/users/delete.js')); ?>"></script>
<script type="module" src="<?php echo e(asset('js/admin/admin.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/exfjkuc5yqp3/gofilm.click/resources/views/admin/role-permission/user/index.blade.php ENDPATH**/ ?>