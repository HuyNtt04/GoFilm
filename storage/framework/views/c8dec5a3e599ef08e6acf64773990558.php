...
<?php $__env->startSection('title', 'Phim VIP'); ?>
...
<main class="pt-28 max-w-7xl mx-auto px-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold">Phim VIP</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                            ...
                            <div class="flex items-center space-x-2 w-1/2">
                                <input type="checkbox" name="countries[]" value="<?php echo e($country->country); ?>"
                                    id="country_<?php echo e($country->country); ?>" class="accent-yellow-400">
                        ...
                        <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                            ...
                            <div class="flex items-center space-x-2 w-1/2">
                                <input type="checkbox" name="categories[]" value="<?php echo e($category->id); ?>"
                                    id="category_<?php echo e($category->id); ?>" class="accent-yellow-400">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                            ...
                            <div class="flex items-center space-x-2 w-1/2">
                                <input type="checkbox" name="years[]" value="<?php echo e($year->release_year); ?>"
                                    id="year_<?php echo e($year->release_year); ?>" class="accent-yellow-400">
    ...
    <div id="movieList" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
        ...
        <div class="bg-white/5 rounded-md overflow-hidden shadow hover:scale-[1.02] transition duration-200">
            <a href="<?php echo e(route('MovieInfo.show', $movie->id)); ?>">
                <img src="<?php echo e(asset($movie->thumbnail)); ?>" alt="<?php echo e($movie->title); ?>" class="w-full h-60 object-cover">
                <div class="p-3">
                    <p class="text-sm font-semibold text-white"><?php echo e($movie->title); ?></p>
                    <span class="inline-block mt-2 px-2 py-0.5 text-xs bg-yellow-500 text-black rounded">VIP</span>
                </div>
            </a>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('../layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/exfjkuc5yqp3/gofilm.click/resources/views/user/vip_movies.blade.php ENDPATH**/ ?>