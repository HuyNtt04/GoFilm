        ...
        <section class="py-6 px-6 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        class="rounded-xl p-4 bg-gradient-to-br <?php echo e($category->gradient); ?> shadow hover:scale-105 transition">
            ...
            <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-[#1b1b1b] rounded-2xl p-4 border border-white/10">
                    ...
                    <ul class="space-y-3">
                        ...
                        <?php for($i = 0; $i < count($moviesByViewInWeek); $i++): ?>
                        <a href="<?php echo e(route('MovieInfo.show', $moviesByViewInWeek[$i]->id)); ?>">
                             <li class="flex items-center gap-3 text-sm">
                                <span class="text-gray-400"><?php echo e($i + 1); ?>.</span>
                                <img src="<?php echo e(asset($moviesByViewInWeek[$i]->thumbnail)); ?>" class="w-7 h-10 rounded" />
                                <span><?php echo e($moviesByViewInWeek[$i]->title); ?></span>
                            </li>
                        </a>
                        <?php endfor; ?>
                    </ul>
                ...
                <div class="bg-[#1b1b1b] rounded-2xl p-4 border border-white/10">
                    ...
                    <ul class="space-y-3">
                        <?php for($i = 0; $i < count($moviesByFavorite); $i++): ?>
                        <a href="<?php echo e(route('MovieInfo.show', $moviesByFavorite[$i]->id)); ?>">
                            <li class="flex items-center gap-3 text-sm">
                                <span class="text-gray-400"><?php echo e($i + 1); ?>.</span>
                                <img src="<?php echo e(asset($moviesByFavorite[$i]->thumbnail)); ?>" class="w-7 h-10 rounded" />
                                <span><?php echo e($moviesByFavorite[$i]->title); ?></span>
                            </li>
                        </a>
                        <?php endfor; ?>
                    </ul>
                    ...
                    <ul class="space-y-3">
                        <?php for($i = 0; $i < count($top5HotCategories); $i++): ?>
                            <li class="flex items-center gap-3 text-sm"><span
                                    class="text-gray-400"><?php echo e($j = $i + 1); ?>.</span> <span
                ...
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button
                            ...
                            <a href="<?php echo e(route('MoviesByCondition.index', 'USA')); ?>"><span class="hidden sm:inline">Xem
                                    thêm</span></a>
...
<?php echo $__env->make('../layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DuAnTotNghiep\Project\download\final3\GoFilm\GoFilm\resources\views/user/home.blade.php ENDPATH**/ ?>