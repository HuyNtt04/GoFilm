...
<main class="pt-24 max-w-7xl mx-auto px-4">
    ...
    <div class="w-full aspect-video bg-black mb-8 relative">
        <iframe src="<?php echo e($videoData['url']); ?>" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
    ...
    <div class="flex flex-col md:flex-column gap-6">
        ...
        <div class="flex gap-2 my-3">
            ...
            <a href="<?php echo e(route('MovieDetail.show', ['id' => $movie->id, 'episode_id' => $currentEpisode->id, 'server' => $s->server_name])); ?>"
                class="bg-white/10 hover:bg-yellow-400 hover:text-black text-white font-semibold py-2 rounded text-center
                      <?php echo e($videoData['server_name'] === $s->server_name ? 'bg-blue-600 text-white' : 'bg-gray-200'); ?>">
                Server <?php echo e($s->server_name); ?>
                    ...
                    <div class="flex-1">
                        ...
                        <form action="<?php echo e(route('Replies.store')); ?>" method="post">
                            ...
                            <div class="reply-form hidden mt-3">
                                ...
                                <input type="hidden" name="received_id" value="<?php echo e($latestCommentByMovie->idUser); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('../layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/exfjkuc5yqp3/gofilm.click/resources/views/user/movie_detail.blade.php ENDPATH**/ ?>