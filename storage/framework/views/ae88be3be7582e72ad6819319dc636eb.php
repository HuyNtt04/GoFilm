...
<div class="recentOrders">
    <div class="cardHeader">
        <h2>Movies</h2>
        <a href="<?php echo e(route('admin.movie.create')); ?>" class="btn-add">Thêm Phim</a>
        <button href="<?php echo e(route('admin.movie.del')); ?>" style="opacity: 0.5" class="btn" id="soft-delete">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete movie')): ?>
        <a href="<?php echo e(route('admin.movie.bin')); ?>" class="bin-button">
            🗑️
        </a>
        <?php endif; ?>
    </div>
    <form method="GET" action="<?php echo e(route('admin.movie.index')); ?>">
        <select name="is_series" onchange="this.form.submit()">
            <option value="0" <?php echo e($is_series === false ? 'selected' : ''); ?>>Phim lẻ</option>
            <option value="1" <?php echo e($is_series === true ? 'selected' : ''); ?>>Phim bộ</option>
        </select>
    </form>
    <table class="table">
        <thead>
        ...
        <tbody>
            ...
            <tr id="movie-<?php echo e($movie->id); ?>">
                ...
                <td>
                    ...
                    <a class="btn-edit" href="<?php echo e(route('admin.movie.edit', $movie->id)); ?>" class="btn-edit">Edit</a>
                    <label for="isDeleted">
                        <button class="bin btn-delete" name="isDeleted" data-id="<?php echo e($movie->id); ?>">Xóa</button>
                    </label>
                    <a class="btn-edit" href="<?php echo e(route('admin.episodes.index', $movie->id)); ?>" class="btn-edit">Tập</a>
                </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
    <div class="links"><?php echo e($movies->onEachSide(1)->links()); ?></div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/exfjkuc5yqp3/gofilm.click/resources/views/admin/movie/index.blade.php ENDPATH**/ ?>