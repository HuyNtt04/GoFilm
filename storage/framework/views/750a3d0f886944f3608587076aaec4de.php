        ...
        <div id="movieList" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
            <?php if($moviesByCondition->isEmpty()): ?>
                <div class="text-white text-center py-10">
                    <p class="text-lg font-semibold">Chưa có phim bạn tìm.</p>
                </div>
            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('../layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DuAnTotNghiep\Project\download\final3\GoFilm\GoFilm\resources\views/user/movies_by_condition.blade.php ENDPATH**/ ?>