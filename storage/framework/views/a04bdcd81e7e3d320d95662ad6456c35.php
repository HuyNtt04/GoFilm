...
<div class="recentOrders">
    <div class="cardHeader">
        <h2>Bình luận</h2>
        <a href="<?php echo e(route('admin.comments.delete')); ?>" class="btn-delete" id="delete-comments">Xóa</a>
    </div>
    <table class="table">
        <thead>
            <tr>
            ...
            <tr id="comment-<?php echo e($comment->id); ?>">
                ...
                <td>
                    ...
                    <form action="<?php echo e(route('admin.comments.destroy', ['comment'=>$comment->id])); ?>" method="POST"
                        ...
                        <button type="button" id="delete-comment" class="btn-delete">Delete</button>
                    </form>
                </td>
            </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\GoFilm\GoFilm\resources\views/admin/comments/index.blade.php ENDPATH**/ ?>