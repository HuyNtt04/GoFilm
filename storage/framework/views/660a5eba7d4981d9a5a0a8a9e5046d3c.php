        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.roles.addPermsToRole',$role->id)); ?>">Add Permissions To Role</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/exfjkuc5yqp3/gofilm.click/resources/views/admin/role-permission/role/add-permissions.blade.php ENDPATH**/ ?>