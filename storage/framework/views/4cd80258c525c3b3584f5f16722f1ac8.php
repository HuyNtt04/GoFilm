...
<div class="Category">
    <div class="cardHeader">
        ...
        <button href="<?php echo e(route('admin.category.delete')); ?>" class="btn-delete" id="delete-categories">Xóa</button>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr id="category-<?php echo e($category->id); ?>">\
                <td>
                    <label class="container">
                        <input type="checkbox" class="delete-checkbox" value="<?php echo e($category->id); ?>">
                        <div class="checkmark"></div>
                    </label>
                </td>
                ...
                <td>
                    ...
                    <form action="<?php echo e(route('admin.category.destroy', $category->id)); ?>" method="POST"
                        ...
                        <button type="button" class="btn-delete" id="delete-category">Delete</button>
                    </form>
                </td>
            </tr>
    ...
    <div class="links"><?php echo e($categories->onEachSide(1)->links()); ?></div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\GoFilm\GoFilm\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>