        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.subscriptionsplans.create')); ?>">Add Plan</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="recentOrders">
    <div class="cardHeader">
        ...
        <a href="<?php echo e(route('admin.subscriptionsplans.index')); ?>" class="btn-secondary">Quay Lại</a>
    </div>
    <div class="form-container">
        <form data-parsley-validate action="<?php echo e(route('admin.subscriptionsplans.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/exfjkuc5yqp3/gofilm.click/resources/views/admin/subscriptionsplans/create.blade.php ENDPATH**/ ?>