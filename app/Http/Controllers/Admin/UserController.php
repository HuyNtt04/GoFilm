...
class UserController extends Controller implements HasMiddleware
{
    ...
    public function create(){
        return view('admin.role-permission.user.create',['roles'=>Role::pluck('name','name')->all()]);
    }
    ...
    public function edit(User $user){
        ...
        return view('admin.role-permission.user.edit',['user'=>$user,'roles'=>Role::pluck('name','name')->all(),'userRoles'=>$userRoles]);
    }
